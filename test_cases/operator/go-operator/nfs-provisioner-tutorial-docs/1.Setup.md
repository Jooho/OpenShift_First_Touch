...
export ROOT_HOME=/home/jooho/dev/git    #Update (For demo, use "/tmp")
...
export SDK_RELEASE_VERSION=v1.1.0  #Update
export KUSTOMIZE_VERSION=3.8.4
export OPM_VERSION=1.14.3
cd ${ROOT_HOME}
